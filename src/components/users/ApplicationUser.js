                        ...
                        <form onSubmit={props.onSignUpUser} >
                            <div class="set">
                                <div class="pets-name">
                                    ...
                                    <label className="my-1 mr-2" htmlFor="inlineFormCustomSelectPref">Addtl Household members </label>
                                    <select name="otherowned" className="custom-select my-1 mr-sm-2" id="otherowned">
                                        <option selected>Choose ...</option>
